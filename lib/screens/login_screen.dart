            ...
            children: [
              TextField(
                ...
                decoration: InputDecoration(
                  hintText: "E-Posta",
                  hintStyle:
                      TextStyle(color: colors["onPrimary"]), // metni rengi
                  border: OutlineInputBorder(
                    borderRadius: BorderRadius.circular(10),
                    borderSide:
                        BorderSide(color: colors["primary"]!), // Kenar rengi
                  ),
              ...
              ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                  ...
                  backgroundColor: colors["secondary"], // Buton yazı rengi
              ...
              OutlinedButton.icon(
                ...
                label: Text(
                  ...
                  style: TextStyle(
                      fontSize: 16, color: colors["onPrimary"]), // Yazı rengi
                ),
              ),
              SizedBox(height: 12),
              OutlinedButton.icon(
                ...
                label: Text(
                  ...
                  style: TextStyle(
                      fontSize: 16, color: colors["secondary"]), // Yazı rengi
                ),
              ),
            ],
          ),
